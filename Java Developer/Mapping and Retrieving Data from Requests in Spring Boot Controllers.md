...
Аннотация @RequestMapping на уровне класса задает базовый путь (или корневой URL) для всех методов в этом контроллере, поэтому на уровне метода может быть указан только `/hello`.
